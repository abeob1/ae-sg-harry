<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="AE_HarrysWeb_V001.Login"
            ...
            <tr>
                <td align="center">
                    <div style = "margin-top:75px;">
                        <img src="Images/Logo_Small.png" alt="logo" width="140px" />
                    </div>
                    <table border="1" cellpadding="0" cellspacing="0" style="width: 400px; margin-top: 40px;
                        border-color: #A5A5A5; border-collapse: collapse">
                        <tr>
                            <td style="height: 30px; border: 0px solid #A5A5A5; background-color: #1B3B61; color: #fff;
                                    ...
                                    <ContentTemplate>
                                        <table border="0" cellpadding="5" cellspacing="1" align="center" style="border-color: #A5A5A5;
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtUserName" runat="server" Height="20px" Width="300px"></asp:TextBox>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtPassword" runat="server" Height="20px" TextMode="Password" ValidationGroup="validateLogin"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:DropDownList ID="ddlCompany" runat="server" Height="20px" Width="300px">
                                                    </asp:DropDownList>
                                                </td>
                                                <td>
                                                    <asp:RequiredFieldValidator ID="rfvCompany" runat="server" ControlToValidate="ddlCompany"
                                                        Display="Dynamic" ErrorMessage="Please select company">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" align="right">
                                                    <asp:Button ID="btnLogin" runat="server" Text="Login" Style="background-image: Url('Images/bgButton.png');
                                                        color: White; background-repeat: no-repeat;" Width="80px" Height="30px" OnClick="btnLogin_Click"/>
                                                </td>
                                            </tr>
                                            <tr>
