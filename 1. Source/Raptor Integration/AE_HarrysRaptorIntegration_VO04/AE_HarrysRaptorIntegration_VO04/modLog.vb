...
Module modLog
    ...
    Public Structure CompanyDefault
        ...
        Public p_sDiscountItem As String
        Public p_sGLAccount As String
        Public p_szStips As String
        Public p_szSRounding As String
        Public p_szSExcess As String
        Public p_szSServiceCharge As String
