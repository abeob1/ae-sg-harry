App.service('util_SERVICE', ['$http', '$window', '$cookieStore', '$rootScope', function ($http, $window, $cookie, $rootScope) {
    ...
    this.url = "http://harrysrdp.dlinkddns.com:81/UAT/HarrysServices/Mobile.asmx/";
	this.Burl = "http://harrysrdp.dlinkddns.com:81/";
    ...
    this.GetOutLetList = function () {
        ...
        var pam = "sUserName="+this.UsName+"&sPassword="+this.UsPass+"&sCompanyDB="+this.UsDB;
        var promise = $http.post(this.url + "MGet_OutletList", pam, this.config)
